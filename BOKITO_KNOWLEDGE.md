...
- **Primary rail (icon-only, links):**
  ...
  - AI (standaardingang `/ai/assistent` redirect naar `/ai/assistent/internal/customization`; app-header **Assistent**; zijbalk-item **Assistents**; ook Bronnen `/projects`, Koppelingen `/datasources`, en placeholder **MCP servers** `/ai/handelingen` met badge **binnenkort**, niet klikbaar)
  - Data (`/database`)
