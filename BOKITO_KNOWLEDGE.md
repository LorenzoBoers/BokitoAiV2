...
- **Settings-secties:** Personal (profile, notifications, access-security), Workspace (general, branding, members), Channels (channels = email, assistant widget = `/ai/assistent/*`, communication agent, help-centers), Integrations (connected, marketplace, mcp), Autonomy (`/settings/autonomy` = voormalige GovernPage).
