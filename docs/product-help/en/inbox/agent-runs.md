...
4. Click a row to open the run conversation behind it. For items waiting on a yes or no, open the purple **Decisions** sub-view under All communication — the same list Overview **Awaiting decision** uses. Archived agents no longer appear under [Agents](/docs/ai/agents); reassign Agenda wakes that still point at them.
