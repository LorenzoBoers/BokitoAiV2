...
export const COMPANY_HANDBOOK_BLOCKS: Record<string, BlockSeed[]> = {
  ...
  'vision-and-audience': [
    ...
    bullet('Software/project delivery — GitHub-linked repos, PO agent, change queue, doc updates'),
  ...
  'features-and-scope': [
    ...
    bullet('Request a change — doc change requests that wake the PO agent'),
    ...
    bullet('PO agents — /workforce/po, project workstreams — /project/:id/overview'),
  ...
  operations: [
    ...
    bullet('PO agent: read doc tree, process change queue, status_update or decision_request'),
  ...
  roadmap: [
    ...
    bullet('PO agent live with tools: log, read/write docs, decision_request, status_update'),
    ...
    bullet('Change request — human request that wakes PO agent to implement doc or project change'),
