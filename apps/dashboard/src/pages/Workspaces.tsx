            ...
            {workspaces.map((workspace) => {
              ...
              return (
                <button
                  key={workspace.id}
                  type="button"
                  onClick={() => void switchWorkspace(workspace.id).then(() => navigate('/support/inbox/all'))}
                ...
                >
                  ...
                  <div className="mt-5 flex items-center gap-2 text-sm text-text-secondary">
                    ...
                    <span>{t('cards.workspace.openCta')}</span>
      ...
      <Dialog open={createDialogOpen} onOpenChange={setCreateDialogOpen}>
          <DialogContent>
            ...
            <DialogFooter className="gap-2">
              ...
              <Button onClick={() => void handleCreateWorkspace()} disabled={!workspaceName.trim() || createLoading}>
                <Plus size={14} />
