...
3. Niets klantgericht gaat de deur uit tot jij antwoordt, tenzij autonomie dat toestaat. **Taak aanmaken** goedkeuren plant een menselijke opvolging op de [Agenda](/docs/ai/agenda) (geen agent-run). Kies in het gespreksmenu **Opvolgtaak plannen** om titel en wanneer te zetten (vandaag, morgen 9:00, volgende week of geen datum). Een suggestiechip kan dezelfde planner openen. Open opvolging staat onder **Opvolging** in het zijpaneel — vink af daar of op de Agenda. Kies **Toevoegen aan project** in hetzelfde menu om het gesprek met een projectkiezer naar de wachtrij van een project te sturen — echt werk belandt op de projectbacklog zonder het gesprek te verlaten. Zie [Beslissingen](/docs/ai/decisions).
