    ...
    async with async_session_factory() as session:
        ...
        if ai_mode == "suggest":
            ...
            prompt = (
                ...
                "ONLY the customer-facing text: no meta commentary about your research, "
                "no notes about missing information, no dividers. Do NOT write a "
                ...
                "body on a new line starting with exactly: INTERNAL_NOTE: , or\n"
