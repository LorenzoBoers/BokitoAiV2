...
async def resolve_runtime_snapshot(
    ...
    *,
    ...
    snapshot = {
        ...
        "apply_modes_json": profile.apply_modes_json if profile else agent.apply_modes_json,
...
def apply_snapshot_to_agent(agent: Agent, snapshot: dict[str, Any]) -> Agent:
    ...
    return Agent(
        ...
        apply_modes_json=snapshot.get("apply_modes_json") or agent.apply_modes_json,
