  ...
  return (
    ...
    >
      <View style={styles.base}>
        <Text style={[styles.text, styles.baseText, style]}>{children}</Text>
      </View>
      <Animated.View style={[styles.shimmerWrap, { transform: [{ translateX }] }]}>
        <LinearGradient
          colors={['transparent', 'rgba(110,102,255,0.15)', 'rgba(110,102,255,0.85)', 'rgba(110,102,255,0.15)', 'transparent']}
          start={{ x: 0, y: 0.5 }}
          end={{ x: 1, y: 0.5 }}
